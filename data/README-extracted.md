...
## `2024-body-measurements.csv` — 2024 바디프로필 컷 신체 실측 (줄자, 3행)
> 출처: 효주 2024년 일기 원문(6/10·6/23·6/24), 세션 대화 중 수동 입력.

| 컬럼 | 설명 |
|---|---|
| `date` | 측정일 |
| `bust_cm` / `underbust_cm` | 가슴 위/아래 둘레 |
| `waist_cm` | 허리둘레 |
| `hip_cm` | 엉덩이둘레 |
| `note` | 일기 원문·해석 메모 |

- 6/23 일기 원문("여행 다녀왔는데 왜 더 빠졌는가?? 아프느라 잘 못먹어서")이 3번 섹션의 "6월 말 급하강=여행 중 질병" 가설의 1차 근거.
- 6/24 엉덩이 수치(94cm)가 6/23(81.2cm) 대비 급변 — 원본 일기 오기 가능성, 확정 아님.
